...
@section('title', "Upload File - Anesidora")
        ...
        <form action="{{ route('upload.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                <div>
                    ...
                    <textarea name="description" rows="3" class="w-full bg-[#1a1a2e] border border-[#3e3e5a] rounded-xl px-4 py-3 text-[#e0e0e0] focus:ring-2 focus:ring-[#8b5cf6] focus:border-transparent outline-none transition-all placeholder-[#7f8c8d]/50" placeholder="What's this file about?"></textarea>
                </div>
                <div class="space-y-4">
                    <div>
                        <label class="block text-sm font-medium text-[#7f8c8d] mb-2">Privacy Setting</label>
                        <select name="privacy" class="w-full bg-[#1a1a2e] border border-[#3e3e5a] rounded-xl px-4 py-3 text-[#e0e0e0] focus:ring-2 focus:ring-[#8b5cf6] outline-none transition-all appearance-none">
                    ...
                    <div>
                        ...
                        <input type="password" name="password" class="w-full bg-[#1a1a2e] border border-[#3e3e5a] rounded-xl px-4 py-3 text-[#e0e0e0] focus:ring-2 focus:ring-[#8b5cf6] outline-none transition-all placeholder-[#7f8c8d]/50" placeholder="••••••••">
                    </div>
                </div>
            </div>
